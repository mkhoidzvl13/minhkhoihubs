...
local Window = OrionLib:MakeWindow({Name = "Luffy Hub", HidePremium = false, IntroText = "Saber Library", SaveConfig = true, ConfigFolder = "Luffy Hub"})
----------Tab-----------------------
local W = Window:MakeTab({
    Name = "Thông Tin",
    Icon = "rbxassetid://16722272371",
    PremiumOnly = false
})
...
elseif World3 then
	tableBoss = {"Luffy Hub Raid Boss [Lv. 3000]","Stone","Island Empress","Kilo Admiral","Captain Elephant","Beautiful Pirate","rip_indra True Form","Longma","Soul Reaper","Cake Queen"}
end
