...
----------------------------------------------------------------------------------------------------------------------------------------
_G.TieuDe = "Shin Hub"
_G.ThongBao = "Shin Hub"
_G.ThongBaoChoose = "Shin Blox Fruits Script"

_G.Discord = "https://discord.gg/QXUsJnZDBN"
_G.YouTube = "https://youtube.com/@oopsshin1436?"
_G.TikTok = "https://www.tiktok.com/@shincr7edit?"
notis = require(game.ReplicatedStorage:WaitForChild("Notification"))
notis.new("<Color=Yellow>Grayx dev \n<Color=/>".. _G.ThongBao):Display()
_G.SafeFarm = true
...
local MinhKhoi = Instance.new("ScreenGui")
 MinhKhoi.Name = " MinhKhoi"
 MinhKhoi.Parent = game.CoreGui
 MinhKhoi.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

local Main = Instance.new("Frame")
Main.Name = "Main"
Main.Parent = MinhKhoi
...
-- UIStroke.Archivable = true
			...
			UICorner_2.Parent = Button
				...
				imgLabelIcon.Image = "rbxassetid://16632632847" 
...
return dropfunc
    ...
    function main:AddSlider(text, min, max, start, callback)
                ...
                ImageLabel.Image = "rbxassetid://16632632847"
...
if game.PlaceId == 2753915549 then
    ...
    Notification.Notify("Notification", "Game Not Support :( | Only Blox Fruits.", "rbxassetid://16632632847", {
    Duration = 10,       
    Main = {
        Rounding = true,
    }
...
--------------------------------------------------------------------------------------------------------
local Library = Update:Window("Shin HUB","BLOX FRUIT",Enum.KeyCode.RightControl);
--------------------------------------------------------------------------------------------------------
local Khoi = Library:AddTab("Information","rbxassetid://16632632847")
local Settings = Library:AddTab("Settings Farming","rbxassetid://16632632847")
local Main = Library:AddTab("General","rbxassetid://16632632847")
local M = Library:AddTab("Item & Quest","rbxassetid://16632632847")
local Ss = Library:AddTab("Stats","rbxassetid://16632632847")
local RaceV4 = Library:AddTab("Race V4","rbxassetid://16632632847")
local EventGame = Library:AddTab("Game Event","rbxassetid://16632632847")
local P = Library:AddTab("Local Player","rbxassetid://16632632847")
local Status = Library:AddTab("Status Sever","rbxassetid://16632632847")
local Visual = Library:AddTab("Visual","rbxassetid://16632632847")
local R = Library:AddTab("Dungeon","rbxassetid://16632632847")
local T = Library:AddTab("Teleport","rbxassetid://16632632847")
local S = Library:AddTab("Shop","rbxassetid://16632632847")
local D = Library:AddTab("Devil Fruit","rbxassetid://16632632847")
local Misc = Library:AddTab("Miscellaneous","rbxassetid://16632632847")
--------------------------------------------------------------------------------------------------------
Khoi:AddSeperator("Shin HUB")
Khoi:UserMinhKhoi()
local Creator = Khoi:AddLabel('Hii '..game.Players.LocalPlayer.Name.." To Shin HUB !! Thanks Using.")

spawn(function()
    while wait() do
        pcall(function()
            if game.Players.LocalPlayer.Name == "NguyenMinhKhoi" then
...
Khoi:AddSeperator("🧑‍💻 Developer: Grayx 🧑‍💻")
Khoi:AddLabel("Owner: Shin")
Khoi:AddSeperator("Social Network")
Khoi:AddButton('Discord Sever', function()
setclipboard(_G.Discord)
end)
Khoi:AddButton('YouTube Official', function()
setclipboard(_G.YouTube)
end)
Khoi:AddButton('Tik Tok Official', function()
...
Settings:AddToggle("Disabled Notifications Text",false,function(Khoi)
_G.Remove_trct = Khoi
end)
				...
				if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman",true) == 1 then
						...
						game.StarterGui:SetCore("SendNotification", {
							...
							Icon = "http://www.roblox.com/asset/?id=16632632847",
							Duration = 2.5
						})
					end
...
M:AddToggle("Auto Find Full Moon",_G.AutoFindFullmoon,function(value)
 ...
 spawn(function()
        while wait() do
            ...
            elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=16632632847" then
                Hop()
                game.StarterGui:SetCore("SendNotification", {
					Title = "Shin HUB", 
					Text = "Wait New Server" ,
...
task.spawn(function()
	while task.wait() do
		pcall(function()
			if NguyenMinhKhoi and _G.BringMonster then
				for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
					if not string.find(v.Name,"Boss") and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= _G.BringMode then
						if InMyNetWork(v.HumanoidRootPart) then
...
local FM = Status:AddLabel('Wait For Moon...')
    ...
    task.spawn(function()
            while task.wait() do
                pcall(function()
                    if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=16632632847" then
...
ImageButton1.Image = "http://www.roblox.com/asset/?id=16632632847"
...
----------------------------------------------------------------------------------------------------------------------------------------
Notification.Notify("Notification", "Thank You for Using Shin HUB.", "rbxassetid://16632632847", {
    Duration = 5,       
    Main = {
        Rounding = true,
    }
...
wait(6)
Notification.Notify("Notification", "If You Use Fluxus, Shin HUB Will Optimize Fluxus Well.", "rbxassetid://16632632847", {
    Duration = 10,       
    Main = {
        Rounding = true,
    }
